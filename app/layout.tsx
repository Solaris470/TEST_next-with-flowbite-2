  ...
  return (
    <html lang="en">
      ...
      <body className={inter.className}>
        ...
        <aside
          id="logo-sidebar"
          className="fixed left-0 top-0 z-1 h-screen w-64 -translate-x-full border-r border-gray-200 bg-white pt-20 transition-transform dark:border-gray-700 dark:bg-gray-800 sm:translate-x-0"
          aria-label="Sidebar"
        >
            ...
            <ul className="space-y-2 font-medium">
              <li>
                ...
                >
                  ...
                  <span className="ms-3">Apex Chart</span>
                </a>
              </li>
              <hr />
              <li>
        ...
        <div className="p-4 sm:ml-64">
          <div className="p-4rounded-lg mt-14">{children}</div>
        </div>
